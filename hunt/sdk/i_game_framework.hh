#pragma once
#include "i_action_map_manager.hh"
#include "i_entity.hh"
#include "../cheat/addresses/addr.hh"

class i_game_framwork
{
public:
	...
	virtual void GetILevelSystem() = 0;
	virtual void func27() = 0;
	virtual void func28() = 0;
	virtual i_action_map_manager* get_i_action_map_manager() = 0;
	...
	virtual i_entity* GetClientEntity() const = 0;
	...
	static i_game_framwork* get_i_game_framwork() { return *reinterpret_cast<i_game_framwork**>(addr::i_game_framework); };
};