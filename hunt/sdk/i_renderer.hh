...
public:
	...
	virtual bool project_to_screen(float ptx, float pty, float ptz, float* sx, float* sy, float* sz) = 0;
	...
	static i_renderer* get_i_renderer() { return *reinterpret_cast<i_renderer**>(addr::i_renderer); };
};